<x-app-layout>
    ...
    <div align="right">
        @can('create', 'App/Models/Plantacoes')
                ...
                <tbody>
                    @foreach ($plantacoes as $item)
                        <tr>
                            ...
                            <td>{{ $item->user->name }}</td>
                                <td>
                                    ...
                                    @can('delete', $item->plantacoes)
                                        <button type="submit" onclick="showRemoveModal('{{ $item->created_at }}', '{{ $item->plantacoes->nome }}')" class="btn btn-danger">
                            ...
                            <form action="{{ route('deletar', [$item->user->id, $item->plantacoes->id]) }}" id="form_{{$item->created_at}}">
                                @csrf
                            </form>
                        </tr>
                    @endforeach
