<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('insumos_transacao.update', $id) }}">
            @csrf
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('insumos_transacao.show', $id) }}">
                    {{ __('Voltar') }}
                </a>
