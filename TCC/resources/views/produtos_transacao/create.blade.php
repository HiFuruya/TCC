    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('produtos_transacao.store', $id) }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="quantidade" class="block mt-1 w-full" type="number" min="0.01" step=".01" name="quantidade" :value="old('quantidade')" required autofocus />
            </div>          
            ...
            <div class="mt-4">
                ...
                <x-text-input id="valor_unitario" class="block mt-1 w-full" type="number" min="0.01" step=".01" name="valor_unitario" min="0" :value="old('valor_unitario')" required autofocus />
            </div>
