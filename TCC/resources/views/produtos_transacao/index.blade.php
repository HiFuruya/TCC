                        ...
                        <tr>
                            ...
                            <td class="d-none d-md-table-cell">{{ ($item->valor_total)}}</td>
                                <td>
                                    ...
                                    <a href= "{{ route('produtos_transacao.edit', $item->id) }}" class="btn btn-success">
                                    ...
                                    <button type="submit" onclick="showRemoveModal('{{ $item->id }}', '{{ $item->produto->nome }}')" class="btn btn-danger">
