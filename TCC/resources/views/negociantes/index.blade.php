<x-app-layout>
    ...
    <div align="right">
        <a  href="{{ route('negociantes.create') }}" class="btn btn-primary">
                    ...
                    @foreach ($negociantes as $item)
                        <tr>
                            ...
                            <td class="d-none d-md-table-cell">@if($item->tipo == 1)
                                ...
                                <td>
                                        <a nohref style="cursor:pointer" onclick="showInfoModal(['NEGOCIANTE: {{$item->nome}}', 'TELEFONE: {{$item->telefone}}', 'TIPO: @if($item->tipo == 1) COMPRADOR @else VENDEDOR @endif'])" class="btn btn-primary">
