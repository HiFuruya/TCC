    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('vendedor.update', $vendedor) }}">
            ...
            <div>
                ...
                <x-text-input id="nome" class="block mt-1 w-full" type="text" name="nome" :value="$vendedor->empresa[0]->nome" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="doc" class="block mt-1 w-full" type="number" name="doc" :value="$vendedor->empresa[0]->doc" required />
            </div>
